...
def load_assets():
    ...
    assets[cas_IMG] = pygame.image.load(os.path.join(IMG_DIR, 'castilho.jpg')).convert_alpha()
    assets[cas_IMG] = pygame.transform.scale(assets['cas_img'], (METEOR_WIDTH, METEOR_HEIGHT))
    assets[renan_IMG] = pygame.image.load(os.path.join(IMG_DIR, 'renan.jpg')).convert_alpha()
    assets[renan_IMG] = pygame.transform.scale(assets['renan_img'], (SHIP_WIDTH, SHIP_HEIGHT))
